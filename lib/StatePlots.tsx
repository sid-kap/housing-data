...
function makeStateSelect (stateOptions: Option[], stateName: string, router): JSX.Element {
  return (
    <SelectSearch
      search
      value={stateName}
...
export default function StatePlots ({ stateName }: {stateName: string}): JSX.Element {
