...
export default function BarPlot (
  {data, units, perCapita}: { data: PlainObject, units: string, perCapita: boolean }
): JSX.Element {
  return (
    <ContainerDimensions>
      {({ width, height }) => (
...
function makeTransforms(units: string, filterFields: Array<string>, perThousand: boolean): Transform[] {
...
function makeSpec (units: string, perCapita: boolean, width: number, height: number): TopLevelSpec {
