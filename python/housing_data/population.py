...
def get_state_populations_1980s():
    states_80s_text = requests.get(
...
def _get_counties_population_table_1990s(year):
...
def get_state_population_estimates():
    print("Loading 1980s data...")
    df_1980s = get_state_populations_1980s()

    print("Loading 1990s data...")
    df_1990s = get_state_populations_1990s()

    print("Loading 2000s data...")
    df_2000s = get_state_populations_2000s()
